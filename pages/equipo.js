  ...
  return (
    <main className={montse.className}>
      ...
      <div className={styles.title}>
        <div className={`${styles.nuestros} `} style={{overflow: "hidden"}}>
        ...
        <div className={styles.date_text}>2023</div>
          ...
          <Image
            ...
            width={50}
          />
          <div className={styles.date_symetric}>2023</div>
        </div>
        ...
        <div className={`${styles.contenido} row`}>
          ...
          <div className={`${"col-md-6 col-sm-12"} ${styles.info}`}>
            <Image
              ...
              height={600}
            />
            <h2 className={`${styles.textName} ${styles.normalText} `}>
              Alexandra Cuevas
            </h2>
            <p className={styles.normalText}>
              <span className={styles.bold}>Especialidad:</span> Photoshop
            </p>
            <p className={`${styles.contacto} ${styles.normalText}`}>
              <span className={styles.bold}>Contacto:</span>
              <br />
              Instagram: @alexandra.c.pardo
              <br />
              gmail: alexandra.c.pardo@gmail.com
              <br />
          ...
          <div className={`${"col-md-6 col-sm-12"} ${styles.info}`}>
            ...
            <p className={styles.normalText}>
              <span className={styles.bold}>Especialidad:</span> Fotografía
            </p>
            <p className={`${styles.contacto} ${styles.normalText}`}>
              <span className={styles.bold}>Contacto:</span>
              <br />
              Instagram: @ruben.sagrav
              <br />
              gmail: ruben.sagrav@gmail.com
              <br />
          ...
          <div className={`${"col-md-6 col-sm-12"} ${styles.info}`}>
            ...
            <p className={styles.normalText}>
              <span className={styles.bold}>Especialidad:</span> Ilustración
            </p>
            <p className={`${styles.contacto} ${styles.normalText}`}>
              <span className={styles.bold}>Contacto:</span>
              <br />
              Instagram: @uxusofiauxu
              <br />
              gmail: sofia.calvilloxs@gmail.com
              <br />
          ...
          <div className={`${"col-md-6 col-sm-12"} ${styles.info}`}>
            ...
            <p className={`${styles.contacto} ${styles.normalText}`}>
              <span className={styles.bold}>Contacto:</span>
              <br />
              Instagram: @melissanthophilia
              <br />
              gmail: melissapt2@gmail.com
              <br />
          ...
          <div className={`${"col-12"} ${styles.info}`}>
            ...
            <p className={`${styles.contacto} ${styles.normalText}`}>
              <span className={styles.bold}>Contacto:</span>
              <br />
              Instagram: @deborag2000
              <br />
              gmail: deborag2000@gmail.com
              <br />
